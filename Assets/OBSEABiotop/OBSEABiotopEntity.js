...
class OBSEABiotopEntity {
  ...
  constructor(scene){
    ...
    gltfLoader.load('/boiasomorrostro/Assets/OBSEABiotop/biotop.glb', (gltf) => {
      ...
      biotop.material.aoMap = loader.load('/boiasomorrostro/Assets/OBSEABiotop/Textures/BiotopAmbientOcclusion.jpeg');
